...
class Tower
{
    public :
        ...
        Tower *getPrev() { return prev ; }
        Tower *getNext() { return next ; }
        void setCurrent(int current) { this -> current = current ; }
        void setPrev(Tower *prev) { this -> prev = prev ; }
        void setNext(Tower *next) { this -> next = next ; }
    private :
        int current ;
        Tower *prev ;
        Tower *next ;
...
void setBackTower(char from, Tower *tower)
{
    switch (from)
    {
        case 'A' : A = tower ; return ;
        case 'B' : B = tower ; return ;
        case 'C' : C = tower ; return ;
    }
}
